...
local config = {
        ...
        java = {
            ...
            configuration = {
                runtimes = {
                    ...
                    {
                        name = "JavaSE-17",
                        path = "/opt/jdks/jdk-17.0.6/",
                    },
                   --]] 
                    {
                        name = "JavaSE-19",
                        path = "/opt/jdks/jdk-19.0.1/",
                    },
                    --[[
                    {
                        name = "JavaSE-11",
    ...
    cmd = {
        ...
        '-jar', vim.fn.glob('/opt/jdt/plugins/org.eclipse.equinox.launcher_*.jar'),

        -- The configuration for jdtls is also placed where jdtls was installed. This will
        -- need to be updated depending on your environment
        --'-configuration', '/opt/homebrew/Cellar/jdtls/1.18.0/libexec/config_mac',
        '-configuration', '/opt/jdt/config_linux/',
